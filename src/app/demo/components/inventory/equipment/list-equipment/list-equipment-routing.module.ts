...
@NgModule({
	imports: [RouterModule.forChild([
		...
		{ path: 'edit-equipment/:equipmentId', data: { breadcrumb: 'Editar Equipamento' }, loadChildren: () => import('../create-equipment/create-equipment.module').then(m => m.CreateEquipmentModule) },
	])],
